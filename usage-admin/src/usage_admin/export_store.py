...
the local directory store (``USAGE_ADMIN_EXPORT_STORE_DIR``), the S3-compatible
object store (``USAGE_ADMIN_S3_ENDPOINT_URL``; SeaweedFS in the reference
...
_LOGGER = get_logger("usage_admin.export_store")
