...
#: Each service keeps its own Alembic version table. usage-admin and
#: factory-agent share one PostgreSQL database, and a shared ``alembic_version``
#: row would make each service fail on the other's revision ids.
VERSION_TABLE = "alembic_version_usage_admin"
