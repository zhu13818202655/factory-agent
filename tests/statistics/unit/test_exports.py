...
from factory_agent.statistics.container import InMemoryExportFileStore
from factory_agent.statistics.exports import (
    ExportService,
    render_csv,
    render_xlsx,
    sign_download,
...
def test_render_csv_and_xlsx_produce_expected_bytes() -> None:
    from factory_agent.statistics.exports import ExportTable
...
async def test_create_export_builds_file_and_audits() -> None:
    ...
    assert view.download_url.startswith("http://statistics.test")
